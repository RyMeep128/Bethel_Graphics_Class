...
export class GraphicPipeline {
    ...
    public AddDiffusePass(): void {
        ...
        this.uploadDiffuse(shader);

        this.uploadPrevious(shader,this.gAddSpecTex);
    ...
    public stepPass(): void {
        ...
        this.uploadPrevious(shader, this.gEdgeTex)
    ...
    public LightingPass(): void {
        ...
        if (!this.waterColorSettings.waterColorEnabled) {
            ...
            this.gl.bindTexture(this.gl.TEXTURE_2D, this.gEdgeDarkenTex);
            this.gl.uniform1i(
